...
// Demo 1: Discover API boundary nodes via ic0.app (centralized boundary nodes)
// $ cargo run --bin  demo_1_fetch_nodes

#[tokio::main]
async fn main() {
    let url = Url::parse("https://ic0.app").expect("failed to parse url");
