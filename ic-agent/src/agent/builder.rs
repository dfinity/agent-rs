...
// Include the file (generated by build.rs) containing API seed nodes into the crate’s compilation.
...
impl AgentBuilder {
    ...
    pub async fn with_discovery_transport(self, client: reqwest::Client) -> Self {
        ...
        // Use the array of seeds from the generated api_seed_nodes.rs file.
