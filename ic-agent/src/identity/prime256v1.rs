...
";
    ...
    #[test]
    fn test_prime256v1_pkcs8_public_key() {
        let identity = Prime256v1Identity::from_pem(IDENTITY_FILE_PKCS8.as_bytes())
            .expect("Cannot create prime256v1 identity from PKCS#8 PEM file.");
        assert_eq!(
            DER_ENCODED_PUBLIC_KEY,
    ...
    #[test]
    #[should_panic(expected = "UnsupportedKeyCurve")]
    fn test_prime256v1_pkcs8_reject_wrong_curve() {
        // A PKCS#8 secp256k1 key must be rejected by Prime256v1Identity.
        const SECP256K1_PKCS8: &str = "\
-----BEGIN PRIVATE KEY-----
...
-----END PRIVATE KEY-----
";
        Prime256v1Identity::from_pem(SECP256K1_PKCS8.as_bytes()).unwrap();
    }
